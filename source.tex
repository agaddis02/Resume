...
\newcommand{\latestVersion}{\text{\href{https://github.com/agaddis02/Resume/blob/master/Adam_Gaddis_Resume_Dark.pdf}{\color{urlcolor}{\faicon{refresh}} \color{textcolor} {Latest} }}}
...
\begin{resume_header}
    ...
    \program{ Big Data Platforms \& Engineering}
    \contact
    {
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Lead Data Engineer }{March. 2023 - Present}
      \resumeItemListStart
...
\resumeSubheading
      ...
      {Data Platform Engineer}{Jun. 2019 - Aug. 2020}
     \resumeItemListStart
         \resumeItem{Developed Python ETL pipelines to retrieve more than 10 million+ data points daily from in-field SCADA Systems.}
         \resumeItem{Built predictive analytical models forecasting net production returns from various fracking strategies, aiding in strategic decision-making.}
         \resumeItem{Constructed and deployed a Python machine learning model on Databricks ML platform for analyzing incoming deals on long-term PDP wells, utilizing geospatial data and reverse time-series analysis.}
         \resumeItem{Published an internal whitepaper on the model, leading to significant operational tweaks. Collaborated closely with Production Engineers and Geologists to refine the model and enhance its applicability.}
     \resumeItemListEnd
     \resumeTech{Technologies}{Python, Azure, Databricks, Github Actions, SQL Server, Geopandas, Fiona, Shapely, Scikit-learn}
...
\section{Skills}
    \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
        ...
        \resumeTech{Datawarehouse}{Bigquery, Databricks, Azure Synapse} & \resumeTech{Cloud Platforms}{GCP, AWS, Azure}\\
        \resumeTech{Analytics}{Arcgis, All Major BI Tools, } & \resumeTech{ML \& AI}{PyTorch, Keras, OpenCV, Apache Spark MLlib}
    \end{tabular*}
