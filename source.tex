...
\begin{resume_header}
    ...
    \program{ Big Data Platforms \& Engineering | Up-and-Coming Data Leader}
    \contact
    {
...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      {Senior Data Engineer}{May 2024 - Present}
      \resumeItemListStart
      \resumeItem{Mid Level Data Engineer, Working with BI team on Internal Facing Data Applications and Large Scale Data Ingestion Pipelines.}
    \resumeItemListEnd
    \resumeTech{Technologies}{Go, GCP, Bigquery, Clickhouse, Docker, Kubernetes}
...
\section{Education}
  ...
  %     \resumeTech{Notable Courses}{\textit{Graph Theory, Empirical Analysis}}
    ...
    \resumeSubheading
      ...
      {M.B.A Strategic Management Concentration | \textit{GPA: 4.0/4.0} } {Aug. 2024 -- July. 2025  \textit{((Anticipated))}}
      \resumeItemListStart
      \resumeItemListEnd
